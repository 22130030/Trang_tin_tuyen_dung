...
<div class="container">
    ...
    <form action="add-job-posting" method="post" >
        ...
        <input type="text" id="title" name="titleJob" value="" required>

        <!-- Tên công ty -->
        <label for="company">Tên công ty:</label>
        <input type="text" id="company" name="companyName" value="" required>
        ...
        <div class="form-buttons">
            ...
            <a href="job-management.jsp" class="btn-secondary">← Quay lại</a>
        </div>
    </form>
</div>
</body>
